const question = [
  ...
  },
  {
    ...
    answerOptions: [
      { answerText: "15-30 ans" },
      { answerText: "30-50 ans" },
      { answerText: "50+ ans" },
    ],
  },
  {
  ...
  {
    questionText: "Aimez vous les sports de contact ?",
    answerOptions: [{ answerText: "Oui" }, { answerText: "Non" }],
  },
  {
    questionText: "Aimez vous les sports de glisse ?",
    answerOptions: [{ answerText: "Oui" }, { answerText: "Non" }],
  },
  {
    questionText: "Aimez vous les sports de balle ?",
    answerOptions: [{ answerText: "Oui" }, { answerText: "Non" }],
  },
  {
    questionText: "Vous voulez pratiquer seul ?",
    answerOptions: [{ answerText: "Oui" }, { answerText: "Non" }],
  },
];
